...
def generate(text,emotion): 
    ...
    data = json.load(f)
    suggestions.append(data["negative_feedback"][0])
    suggestions.append(data["negative_feedback"][1])
    suggestions.append(data["negative_feedback"][2])
    suggestions.append(data["negative_feedback"][3])
    return suggestions